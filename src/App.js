...
class App extends Component {
  ...
  switchNameHandler = () => {
    ...
    // DON'T do this ---- this.state.persons[0].name = "Ramakrishna";
    this.setState({
      persons : [
  ...
  render() {
    return (
      <div className="App">
        ...
        <Person name={this.state.persons[2].name} age={this.state.persons[2].age}>I am so naughty :)</Person>
        <Person name={this.state.persons[3].name} age={this.state.persons[3].age}>I am so Cute :)</Person>
      </div>
